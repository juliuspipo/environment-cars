...
process.env.APP_NAME = config.args.name || config.buildEnv.CORE_DIR;
process.env.APP_PORT = config.args.port || config.tasksEnv.defaultServerPort;
...
process.env.KARMA_BROWSER = config.args.browser || config.tasksEnv.defaultKarmaBrowser;
